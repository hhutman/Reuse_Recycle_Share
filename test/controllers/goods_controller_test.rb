...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post goods_url, params: { good: { availability: @good.availability, description: @good.description, more_information: @good.more_information } }
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { availability: @good.availability, description: @good.description, more_information: @good.more_information } }
